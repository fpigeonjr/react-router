  ...
  render() {
    return (
      <div className="main-content home">
        ...
        <Link to="teachers/HTML/Tommy-Section">Tommy Section</Link>
        <Link to="teachers/Javascript/Frank-Promise">Frank Promise</Link>
        <Link to="teachers/CSS/Julie-Styles">Julie Styles</Link>
      </div>
    );
  }
}
